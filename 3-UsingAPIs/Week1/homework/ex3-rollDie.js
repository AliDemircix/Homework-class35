...
// We have got a single error and no "success" in the result.
// Because rollDice() returns a Promise object and right after rollOnce(7) executes, reject() function
// becomes result of Promise. For rollOnce(8) and rollOnce(9) they can not reach rejected promise because it has caught earlier.
